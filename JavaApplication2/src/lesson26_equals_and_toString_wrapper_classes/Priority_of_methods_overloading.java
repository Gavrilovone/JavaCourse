 ...
 * 
 * Конвертация типов данных для соотвтствия параметр листу метода не может происходить в 2 этапа, тоесть невозможно например
 * чтобы int конвертировался в long, а потом произошел autoboxing.Нет происходит что-то одно
 */
